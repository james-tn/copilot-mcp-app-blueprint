...
// Python package (server/pega_mcp/web/widget.html), which the MCP server then
// serves as the `ui://pega-blueprint/app.html` resource.
...
const OUT_DIR = path.resolve(__dirname, "..", "server", "pega_mcp", "web");
